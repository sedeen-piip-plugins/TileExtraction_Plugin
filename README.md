...
*Fig1. and the Analysis Manager view. The Tile Extraction plugin is appeared in the algorithm pop up menu.*
...
*Fig2. and the Analysis Manager view. The Tile Extraction plugin is appeared in the algorithm pop up menu.*
...
*Fig3. and the Analysis Manager view. The Tile Extraction plugin is appeared in the algorithm pop up menu.*
