...
![Analysis Manager view](https://github.com/sedeen-piip-plugins/TileExtraction_Plugin/blob/master/Images/TileExtraction_1.png "Fig1. The Analysis Manager view. The “Tile Extraction” plugin is appeared in the algorithm pop up menu.")

3.  Now the user should be able to tune the parameters and run the “Tile Extraction” plugin. 
